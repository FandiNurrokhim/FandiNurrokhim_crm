...
const CreateModal = ({ isOpen, onClose, setRefetch }) => {
    ...
    const calculateSellPrice = () => {
        ...
        const margin = parseFloat(data.margin_percent) || 0;
        ...
        post("/admin/product", {
            onSuccess: () => {
                ...
                Swal.fire({
                    ...
                    text: t("product.createdMessage", "Produk berhasil dibuat."),
                });
            },
            onError: (errors) => {
    ...
    return (
        <Modal show={isOpen} onClose={onClose} title={t("product.pageTitle", "Tambah Produk")}
            type="add"
            maxWidth="2xl"
            onCancel={() => {
                onClose();
